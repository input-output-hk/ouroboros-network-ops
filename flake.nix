{
  ...
  inputs = {
    ...
    # Using cardano-parts release v2025-12-04, we get SSH over SSM migration completed.
    # Currently `cardano-parts` gives us access to cardano-node `10.5.3` and `10.6.1` for pre.
